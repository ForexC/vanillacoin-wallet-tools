ninja.seeder = {
	...
	seed: function (evt) {
		...
		if (ninja.seeder.seedCount == ninja.seeder.seedLimit) {
			...
			document.getElementById("logo").style.visibility = "none";
			// document.getElementById("culturemenu").style.visibility = "none";
	...
	seedKeyPress: function (evt) {
		...
		if (ninja.seeder.seedCount == ninja.seeder.seedLimit) {
			...
			document.getElementById("culturemenu").style.visibility = "visible";
			ninja.seeder.removePoints();
		}
